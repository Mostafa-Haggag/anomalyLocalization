...
def main(config_Dict):
    ...
    print(device)
    model = VAEUNET_noskipp(in_channels=config_Dict['unet_inout_channels'],
...
if __name__ == "__main__":
    ...
    config_dict = {"batch_size": 16,
                   ...
                   "lr": 5e-4,
                   "z_dim": 512,
                   "model_id": 'VAE_with_unet_design_no_skip',
                   "tag": "blue_pill",
    ...
    wandb.init(
        ...
        config=config_dict,
        tags=["VAE_with_unet_design_no_skip", config_dict["tag"]],
    )
